	...
	<div class="container" id="question1">
	    <div class="question col-md-12">
	      ...
	      <div class="col-md-12 choix_joker" id="choix_joker_01">
	      	<div class="col-md-4">
	      		<a href="#" title="Cash" id="cash_01" onclick="decompte();">Cash</a>
	      	</div>
	      	<div class="col-md-4">
    ...
    <div class="container" id="question2">
	    <div class="question col-md-12">
	      ...
	      <div class="col-md-12 choix_joker" id="choix_joker_02">
	      	<div class="col-md-4">
	      		<a href="#" title="Cash" id="cash_02" onclick="decompte();">Cash</a>
	      	</div>
	      	<div class="col-md-4">
	...
	<div class="container" id="question3">
	    <div class="question col-md-12">
	      ...
	      <div class="col-md-12 choix_joker" id="choix_joker_03">
	      	<div class="col-md-4">
	      		<a href="#" title="Cash" id="cash_32" onclick="decompte();">Cash</a>
	      	</div>
	      	<div class="col-md-4">
