...
<div class="col-md-12" id="container">
	<div class="row"> <!-- Row vidéo -->
		...
		<div class="col-md-2 playlist">
			<h3>Score</h3>
	 		<p>Votre score est de <strong id="score"></strong></p>
	 		<a href="#" class="btn btn-default" data-target="#regles" data-toggle="modal">Règles</a>
		</div>
	...
	<div class="row"> <!-- Row jeu -->

		<div class="col-md-12">
		<form action="" method="">
			<div class="container" id="question1">
				    <div class="question col-md-12">
				      <div class="texte_container col-md-12 divquestion1">
				        <h2 style="text-align:center">Question 1</h2>
				          <div id="question_simple_01">Question plus simple</div>
				          <p class="text-center">Ceci est la question 1</p>
				          <br><br>
				      ...
				      <div class="col-md-12 choix_joker text-center btns" id="choix_joker_01">
				      	<div class="col-md-4">
				      		<a href="#" title="Cash" id="cash_01" onclick="decompte01();" class="box foo">Cash</a>
				      	</div>
				      	<div class="col-md-4">
				      		<a href="#" title="Flash" id="flash_01" class="box foo">Flash</a>
				      	</div>
				      	<div class="col-md-4">
				      		<a href="#" title="Bingo" id="bingo_01" class="box foo">Bingo</a>
				      	</div>
				      </div>
